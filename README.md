...
Relaional databases is they type of database structure, in contrast to non-relational databaes or other types. SQL is structed query language, a langauge that allows us to interact and control the relational database.

- [x] Why do tables need a `primary key`?

The primary key is a way to organize and uniquely identify a row or item in a database. This primary key is usually a number that is auto generated in order to allow new data to be entered without over lap.

- [x] What is the name given to a table column that references the primary key on another table.

The table column that refences a primary key in another table is called a foriegn key.

- [x] What do we need in order to have a _many to many_ relationship between two tables.

I am not sure of the intent of the question, as I believe a _many to many_ is not a good practice, and should instead have the two tables that were intended to be _many to many_ as two _one to many_ tables that use an intermediary or junction table that keeps both tables sharing data.
